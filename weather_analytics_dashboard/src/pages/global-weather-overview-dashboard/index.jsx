          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-2 mb-8">
            <form onSubmit={handleSearch} className="flex items-center">
              <input
                ...
                className="flex-1 px-4 py-4 text-lg border-0 outline-none bg-transparent text-gray-900 placeholder-gray-500"
                disabled={isLoading}
              />
              <button
                type="submit"
                disabled={isLoading || !searchQuery?.trim()}
                className="w-12 h-12 bg-[#60a5fa] hover:bg-[#3b82f6] disabled:opacity-50 disabled:cursor-not-allowed rounded-full flex items-center justify-center transition-colors duration-200"
              >
                {isLoading ? (
